...
MIA.content.views.random.get_content = function( self ){
	...
	return '<br><div class="item no-highlight" style="background-image:url(' + MIA.functions.get_image( MIA.content.name, item.name ) + ');">'+
		...
		'</div><br>' +
		'<input id="random-filter" onchange="MIA.content.views.random.filter_value = this.value;" onfocus="MIA.keyboard.disable([ \'/\', \'ESCAPE\' ]);" onblur="MIA.keyboard.enable();"></input>' +
